...
const stickerPackRoutes = require("./routes/sticker-pack.routes");
  ...
  try {
    const [result] = await prisma.$queryRaw`
      SELECT
        ...
        to_regclass('public."StickerPack"')::text as "stickerPackTable",
    ...
    res.json({
      ...
      tables: {
        ...
        StickerPack: Boolean(result.stickerPackTable),
